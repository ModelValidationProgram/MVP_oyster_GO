...
# data
# env
env_all <- as.data.frame(read.csv("data/EnvDat/env_scaled_msxAdjusted_2026-01-29.csv")[,-1])
env_sea <- as.data.frame(read.csv("data/EnvDat/seascape/sea_scaled_expanded_reord_2026-01-29.csv")[,-1])
...
saveRDS(gf_af, paste0("results/lg_results/gf_af_noPea_",Sys.Date(),".RDS"))
...
saveRDS(gf_geno, paste0("results/lg_results/gf_geno_noPea_",Sys.Date(),".RDS"))
