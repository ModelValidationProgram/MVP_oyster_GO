...
# pop colors H1/H2 removed
pop_colors_rm <- data.frame(pop = c("W1-TX","W2-LA","W3-FL","W4-VA","S1-LOLA","S2-DEBY","W5-NH","W6-ME","H1-LARMIX","H2-SEEDMIX"), hex = c("#365C8DFF","#277F8EFF","#1FA187FF","#4AC16DFF","#440154FF","#46337EFF","#9FDA3AFF","#FDE725FF","black","white"), order = 1:10)

surv_final_time_plotting <- merge(surv_final_time_rename_mg, pop_colors_rm, by = "pop")
