...
# remove the funky bags from analysis, will need to calculate these mortalities separately due to dimension issues
...
# add pop to df
merge4_rm2$pop <- str_split_fixed(merge4_rm2$bags_label, "-", 3)[,2]
```
...
# calc survival
e1_surv <- surv_calc_bag(merge4_rm2, 1)
e2_surv <- surv_calc_bag(merge4_rm2, 2)
e3_surv <- surv_calc_bag(merge4_rm2, 3)
e4_surv <- surv_calc_bag(merge4_rm2, 4)
...
write.csv(mort_df, "results/mortality_long_popsite_052925.csv")
write.csv(surv_long_narm, "results/mortality_long_bags_052925.csv")
write.csv(surv_df_ord, "results/mortality_bags_052925.csv")
```
