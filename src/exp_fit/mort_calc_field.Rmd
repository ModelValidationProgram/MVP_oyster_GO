...
spawntrt <- read.csv("data/ExpDat/MVP23-FieldBags_spawn_trt2.csv")
...
event4[which(merge4_narm[merge4_narm$event == 4,]$alive_count > merge4_narm[merge4_narm$event == 3,]$alive_returned),]$bags_label
# MVP-DEBY-2 has more
...
merge4_rm <- merge4_rm[!merge4_narm$bags_label == "MVP-LA-3",]
merge4_rm <- merge4_rm[!merge4_narm$bags_label == "MVP-DEBY-2",]
...
e4_surv <- surv_calc_bag(merge4_rm, 4)
